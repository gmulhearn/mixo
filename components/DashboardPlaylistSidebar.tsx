...
export const DashboardPlaylistSidebar = ({ onCloseDrawer, playlistsMetadata, setCurrentPlaylistId, refreshPlaylists, currentPlaylistId, ...rest }: SidebarProps) => {
    ...
    const selectNewPlaylist = (playlistId: string) => {
        setCurrentPlaylistId(playlistId)
        onCloseDrawer() // nav out of drawer if open
    }
    ...
    return (
        <Box
            ...
            {playlistsMetadata ? (playlistsMetadata.map((playlist) => (
                <NavItem key={playlist.id} onClick={() => {
                    selectNewPlaylist(playlist.id)
                 }}
